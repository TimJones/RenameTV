...
tar --exclude-vcs --exclude --exclude "$PROJECT-$VERSION/build/*" --exclude "$PROJECT-$VERSION/build" --exclude "$PROJECT-$VERSION/${PWD##*/}/*" --exclude "$PROJECT-$VERSION/${PWD##*/}" --exclude "$PROJECT-$VERSION/*.pro.user" -czhvf ${PROJECT}_${VERSION}.orig.tar.gz $PROJECT-$VERSION/
